...
const roots = ['package.json','tsconfig.base.json','packages/domain','packages/contracts','tests/benchmark','scripts','supabase/config.toml','supabase/migrations','.github/workflows'];
const allowed = new Set(['.ts','.mjs','.json','.sql','.toml','.yml','.yaml']); const failures = [];
